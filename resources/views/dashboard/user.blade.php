...
<div class="flex h-screen overflow-hidden">
    ...
    <aside
        ...
        class="sidebar fixed left-0 top-0 z-9999 flex h-screen w-[290px] flex-col overflow-y-auto overflow-y-hidden border-r border-gray-200 bg-white px-5 transition-all duration-300 dark:border-gray-800 dark:bg-black lg:static lg:translate-x-0"
          ...
          >
            others
                ...
                Ui Elements
                      ...
                      <span
                          class="menu-dropdown-badge"
                          :class="page === 'avatars' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'"
                      >
                        Pro
                      </span>
                    </span>
                      ...
                      <span
                          class="menu-dropdown-badge"
                          :class="page === 'badge' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'"
                      >
                        Pro
                      </span>
                    </span>
                      ...
                      <span
                          class="menu-dropdown-badge"
                          :class="page === 'breadcrumb' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'"
                      >
                        Pro
                      </span>
                    </span>
                      ...
                      <span
                          class="menu-dropdown-badge"
                          :class="page === 'buttonsGroup' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'"
                      >
                        Pro
                      </span>
                    </span>
                      ...
                      <span
                          class="menu-dropdown-badge"
                          :class="page === 'links' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'"
                      >
                        Pro
                      </span>
                    </span>
                      ...
                      <span
                          class="menu-dropdown-badge"
                          :class="page === 'ribbons' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'"
                      >
                        Pro
                      </span>
                    </span>
                      ...
                      <span
                          class="menu-dropdown-badge"
                          :class="page === 'tabs' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'"
                      >
                        Pro
                      </span>
                    </span>
                ...
                Authentication
                      ...
                      <span
                          class="menu-dropdown-badge"
                          :class="page === 'resetPassword' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'"
                      >
                        Pro
                      </span>
                    </span>
                      ...
                      <span
                          class="menu-dropdown-badge"
                          :class="page === 'twoStepVerification' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'"
                      >
                        Pro
                      </span>
                    </span>
          ...
          <span class="mr-3 overflow-hidden rounded-full h-11 w-11">
            ...
            >
              Musharof Chowdhury
                                    ...
                                    >
              <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="295b48474d46445c5a4c5b695940444346074a4644">[email&#160;protected]</a>
            </span>
                                </div>
        ...
        9.05%
                        ...
                        >
                            ...
                            <div class="max-w-full overflow-x-auto">
                                <div id="chartOne" class="-ml-5 h-full min-w-[690px] pl-2"></div>
                            </div>
                        </div>
                        <!-- ====== Chart One End -->
                    </div>
            ...
            2,379 Customers
                                    ...
                                    <div class="flex w-full max-w-[140px] items-center gap-3">
                                        <div
                                            class="relative block h-2 w-full max-w-[100px] rounded bg-gray-200 dark:bg-gray-800"
                                        >
                                            <div
            ...
            589 Customers
                    ...
                    <div class="col-span-12 xl:col-span-7">
                        ...
                        >
                            ...
                            <div class="max-w-full overflow-x-auto">
                                <div class="min-w-[617px] 2xl:min-w-[808px]">
                                    <!-- table header start -->
                                    <div
                                        class="grid grid-cols-10 border-t border-gray-100 py-3 dark:border-gray-800"
                                    >
                ...
                2 Variants
                                        ...
                                        <div class="col-span-2 flex items-center">
                                            <p class="text-theme-sm text-gray-500 dark:text-gray-400">Laptop</p>
                                        </div>
                                        <div class="col-span-2 flex items-center">
                                            <p class="text-theme-sm text-gray-500 dark:text-gray-400">$2399.00</p>
                                        </div>
                                        <div class="col-span-2 flex items-center">
                                            <p
                ...
                1 Variants
                                        ...
                                        <div class="col-span-2 flex items-center">
                                            <p class="text-theme-sm text-gray-500 dark:text-gray-400">Watch</p>
                                        </div>
                                        <div class="col-span-2 flex items-center">
                                            <p class="text-theme-sm text-gray-500 dark:text-gray-400">$879.00</p>
                                        </div>
                                        <div class="col-span-2 flex items-center">
                                            <p
                ...
                2 Variants
                                        ...
                                        <div class="col-span-2 flex items-center">
                                            <p class="text-theme-sm text-gray-500 dark:text-gray-400">$1869.00</p>
                                        </div>
                                        <div class="col-span-2 flex items-center">
                                            <p
                                                class="rounded-full bg-success-50 px-2 py-0.5 text-theme-xs font-medium text-success-600 dark:bg-success-500/15 dark:text-success-500"
                ...
                2 Variants
                                        ...
                                        <div class="col-span-2 flex items-center">
                                            <p class="text-theme-sm text-gray-500 dark:text-gray-400">$1699.00</p>
                                        </div>
                                        <div class="col-span-2 flex items-center">
                                            <p
                ...
                1 Variants
                                        ...
                                        <div class="col-span-2 flex items-center">
                                            <p class="text-theme-sm text-gray-500 dark:text-gray-400">$240.00</p>
                                        </div>
                                        <div class="col-span-2 flex items-center">
                                            <p
